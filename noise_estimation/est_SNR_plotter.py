...
if __name__ == '__main__':
	...
	names = ['WASP-178', 'WASP-167', 'WASP-76', 'WASP-77', 'WASP-121', 'WASP-122', 'WASP-87', 'WASP-103', 'MASCARA-1', 'WASP-19', 'WASP-82', 'MASCARA-4', 'WASP-189', 'WASP-74']


	# snr_st_5 = np.array([241, 208,138,124,124,57,338,65,188,338,750,241])
	snr_st_5 = np.array([241, 229,447,388,265,241,241,124,620,138,353,620,1300,447])
	tint_min = 0.9*np.array([300,300,300,300,300,300,300,300,300,300,300,300,300,300])
	snrs = snr_st_5*np.sqrt(tint_min/5)
	# print(snrs)

	nlines = np.array([400,2000, 2000,2000,400,2000,400,400,400,2000,400,400,70,2000])	
	eta = 0.55
